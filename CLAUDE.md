...
- **post-v1.6.0, deployed 2026-09-06** — a day of accuracy and dead-end fixes. Eight functional commits plus docs, no version bump, no `deployg` (nothing changed a command's option definitions).
