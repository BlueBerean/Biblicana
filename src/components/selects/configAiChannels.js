...
export default {
    ...
    async execute(interaction, database) {
        ...
        try {
            const [currentEnabled, currentMemoryScope, currentDeniedRoles, currentRequiredRoles] = await Promise.all([
            ...
            await interaction.editReply({
                ...
                components: buildAiConfigView({ currentEnabled, currentMemoryScope, currentChannels: channelIds, currentDeniedRoles, currentRequiredRoles }),
            });
